...
class VGG16_D(object):
    def __init__(self, n_classes=1000, train=False):
        ...
        self.layers['group3'] = self.pooling_group(self.layers['group2'], 256, 'group3', 3)
        ...
        layers.variable_summaries(self.layers['fc1'], 'fc1')
        self.layers['fc2'] = layers.affine(self.layers['fc1'], 4096, name='fc1')
        layers.variable_summaries(self.layers['fc2'], 'fc2')       
